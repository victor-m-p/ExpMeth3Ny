...
# Plot showing mean Child MLU for Diagnosis
ggplot(df, aes(x = Diagnosis, y = mean(CHI_MLU), fill = Diagnosis)) + 
  geom_bar(stat = 'identity')+
  labs(x = "Diagnosis", y = "Child MLU")+
  ggtitle("Child MLU and Diagnosis") #Higher MLU for TD than ASD
